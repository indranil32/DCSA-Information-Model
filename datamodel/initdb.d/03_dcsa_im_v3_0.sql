...
CREATE VIEW dcsa_im_v3_0.aggregated_events AS
 SELECT transport_event.event_id,
    ...
    NULL::UUID AS shipping_instruction_id,
...
UNION
 SELECT shipment_event.event_id,
    ...
    shipment_event.shipping_instruction_id,
    shipment_event.payload
...
-- ;
--
-- ALTER TABLE dcsa_im_v3_0.transport_document ADD CONSTRAINT "FK_Transport Document_Party"
-- 	FOREIGN KEY (issuer) REFERENCES dcsa_im_v3_0.party (id) ON DELETE No Action ON UPDATE No Action
-- ;
--
